...
<body>
	<div class="container-fluid">
		...
		<a href="admin_panel.php"> <h1 style="display:inline;color: white;">Playlist</h1></a>	
    </div>
    <div class="container">
      <!-- dropdown  -->
          <div class="dropdown">
       ...
       <div class="row heading">
           ...
           <div class="col-8 cell">File Details</div>
           <div class="col-1 cell">Play</div>
  ...
  <script type="text/javascript"src="lib\bootstrap.min.js"></script>
	<script type="text/javascript" src="admincontrolv2.js"></script>
</body>
</html>
<?php
}
